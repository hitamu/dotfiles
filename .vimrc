...
nnoremap <silent><leader>o :Unite -quick-match -max-multi-lines=2 -start-insert -auto-quit history/yank<CR>

" Quick tab navigation
nnoremap <silent><leader>' :Unite -quick-match -auto-quit tab<CR>

" Fuzzy find files
"nnoremap <silent><leader>f :Unite file_rec/async:! -buffer-name=files -start-insert<CR>
...
" Set split to the right of current window
set splitright
...
"--------------------------------------------------
" Map Ctrl + J/K/L/H to split screen
map <c-j> <c-w>j
map <c-k> <c-w>k
map <c-l> <c-w>l
map <c-h> <c-w>h
...
"-------------------------------------------------
" Enable execute pathogen plugin
